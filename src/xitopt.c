/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i xitopt.ggo -F xitopt 
...
const char *gengetopt_args_info_purpose = "A tool for iterating over the IPv4 space";

const char *gengetopt_args_info_usage = "Usage: xiterate [OPTIONS]... [SUBNETS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nExamples:\n    xiterate (iterate over all public IPv4 addresses)\n    xiterate -b exclusions 10.0.0.0/8 (iterate all IPs in 10./8 except those in\nblacklist)\n",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->shards_help = gengetopt_args_info_help[9] ;
  args_info->shard_help = gengetopt_args_info_help[10] ;
  args_info->help_help = gengetopt_args_info_help[12] ;
  args_info->version_help = gengetopt_args_info_help[13] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "b:w:l:v:e:n:hV", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'e':	/* Seed used to select address permutation.  */
          ...
          break;
        case 'n':	/* Cap number of IPs to generate (as a number or a percentage of the address space).  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "ignore-blacklist-errors") == 0)
          {
