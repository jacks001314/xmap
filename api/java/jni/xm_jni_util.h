...
#ifndef XM_JNI_UTIL_H
#define XM_JNI_UTIL_H

#include <jni.h>
#include <string.h>

static inline void xm_set_int_field(JNIEnv *jenv,jobject jobj,const char *f,int v){
...
static inline void xm_set_long_field(JNIEnv *jenv,jobject jobj,const char *f,long v){
...
static inline void xm_send_data_to_java(JNIEnv *jenv,jobject jobj,void *data,long dlen){
...
static inline void xm_send_data_to_java2(JNIEnv *jenv,jobject jobj,void *data,long dlen){
...
static inline const char * xm_string_arg_get(JNIEnv *jenv,jstring jstr){
