...
const char xm_month_snames[12][4] =
{
    "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"
};

const char xm_day_snames[7][4] =
{
...
int xm_rfc822_date(char *date_str, xm_time_t t)
{
    ...
    xm_time_exp_gmt(&xt, t);

    /* example: "Sat, 08 Jan 2000 18:31:41 GMT" */
    /*           12345678901234567890123456789  */

    s = &xm_day_snames[xt.tm_wday][0];
    *date_str++ = *s++;
    *date_str++ = *s++;
    *date_str++ = *s++;
    *date_str++ = ',';
...
int xm_strftime(char *s, size_t *retsize, size_t max, 
                        const char *format, xm_time_exp_t *xt)
{
    struct tm tm;
