...
typedef struct xm_configfile_t xm_configfile_t;
struct xm_configfile_t {
    /**< an xm_file_getc()-like function */
    int (*getch) (char *ch, void *param);
    /**< an xm_file_gets()-like function */
...
/**
 * Open a xm_configfile_t as xm_file_t
 * @param ret_cfg open xm_configfile_t struct pointer
...
/**
 * Read one line from open xm_configfile_t, strip leading and trailing
 ...
 */
int xm_cfg_getline(char *buf, size_t bufsize, xm_configfile_t *cfp);


/**
 * Detach from open xm_configfile_t, calling the close handler
